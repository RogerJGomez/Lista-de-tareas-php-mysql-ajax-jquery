        ...
        var TableExport = function (selectors, options, isUpdate) {
            ...
            self.selectors.each(function () {
                ...
                function createObjButton(dataObject, myContent, myClass) {
                    var exportButton = "<center><button data-fileblob='" + dataObject + "' class='btn btn-primary btn-block' style='width:309px; margin-top:10px; height:37px;'hidden id='descarga'><i class='fas fa-download' style='margin-right:5px'></i>" + myContent + "</button></center>";
                    boton = exportButton;
                    
                    checkCaption(exportButton);   
                    $('#div').html(exportButton);
